...
The dynamics aim to find the positions of particles  for a given time tt. Numerical integration of the differential equations is required for this purpose. The Euler method, Leap Frog method, Verlet method, and Runge-Kutta method are employed for numerical calculations.
